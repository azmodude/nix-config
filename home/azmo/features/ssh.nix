{
  ...
  home.file.".ssh/keys.public/netcup.pub".text = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGgxP6hdnBAK8gYgHBFwmtNvgQmFii0RUiSifZ3KgmlU";
  home.file.".ssh/keys.public/upcloud.pub".text = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJ6nxegS8y2rC6ldf4mxG3iyuJilxvDLzCote2RSmViG";
  home.file.".ssh/keys.public/luks-unlock-workstations.pub".text = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIAFOj2KxBYTb6MclwoN4xgKN7OgX4Iwv4lViluKPdL9K";
}
